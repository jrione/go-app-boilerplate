...
const file_proto_example_proto_rawDesc = "" +
	"\n" +
	"\x13proto/example.proto\x12\aexample\"\"\n" +
	"\fHelloRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\")\n" +
	"\rHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2K\n" +
	"\x0eExampleService\x129\n" +
	"\bSayHello\x12\x15.example.HelloRequest\x1a\x16.example.HelloResponseB,Z*github.com/jrione/go-app-boilerplate/protob\x06proto3"
